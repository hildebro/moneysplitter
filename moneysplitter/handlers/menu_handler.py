...
def settings_callback(update, context):
    ...
    reply_markup = InlineKeyboardMarkup([
        [button(f'remove-items_{checklist.id}', trans.t('item.delete.link'), emojis.BIN)],
        [button(f'remove-users_{checklist.id}', trans.t('checklist.participant.remove.link'), emojis.RUNNER)],
        [button('delete_checklist', trans.t('checklist.delete.link'), emojis.HAZARD)],
